...
Embedded Linux Distribution in a Kernel
   ...
   more [2]device tree files (.dtb) that are specific to particular
   ...
   [3]http://repo.munts.com/muntsos/kernels
...
Extensions
   ...
   packages from the [4]Debian project will probably not work with
   ...
   The [5]GPIO Server extension package demonstrates how to build a Debian
   ...
   [6]http://repo.munts.com/muntsos/extensions
...
Thin Servers
  ...
  Boot Files + Kernel Files + Extensions = Thin Server
   ...
   Note: BeagleBone boards require the [7]boot flag to be set on the FAT32
...
Boards
  ...
  BeagleBone
   ...
   The [11]BeagleBone was one of the first low cost Linux microcomputers.
   It originally sold for USD $89 at its launch in October 2011.

   The BeagleBone has a Texas Instruments [12]Sitara AM3359 processor
   ...
   to the AM3359 console serial port. The BeagleBone also has two [13]PRU
   ...
   are are enabled on the two 46-pin [14]expansion headers:
   ...
   processor are apparently still available from [15]Special Computing.

  BeagleBone Black

   The [16]BeagleBone Black is a cost reduced version of the BeagleBone.
   ...
   pins and peripheral ports available on its two 46-pin [17]expansion
   headers. Even after eMMC, I2C, SPI, and UART pins have been allocated,
   there are 42 GPIO pins available.

   The BeagleBone Black has a Texas Instruments [18]Sitara AM3358
  ...
  BeagleBone Black Wireless
   ...
   The [19]BeagleBone Black Wireless is a variant of the BeagleBone Black
  ...
  BeagleBone Green
   ...
   The [20]BeagleBone Green is a cost reduced version of the BeagleBone
   Black, from Chinese manufacturer [21]Seeed Studio, that sells for about
   USD $44. Changes from the BeagleBone Black design are:
     ...
     * Added two [22]Grove System connectors, one carrying 3.3V [23]I2C
       signals and one carrying 3.3V logic level [24]serial port signals.
   ...
   but provides many more GPIO pins on its two 46-pin [25]expansion
  ...
  BeagleBone Green Wireless
   ...
   The [26]BeagleBone Green Wireless is a variant of the BeagleBone Green
   that has replaced the wired Ethernet interface with a built-in Wifi
   ...
   [27]BeagleBone Click Shield, which has some advantages over the newer
   [28]mikroBus Cape.

  PocketBeagle

   The [29]PocketBeagle is a cost and size reduced version of the
   ...
   following devices on its two 36-pin [30]expansion headers:
   ...
   rows match the [31]MikroElektronika mikroBUS specification. If female
   sockets are installed on the top of the PocketBeagle, two [32]Click
  ...
  Raspberry Pi 1
   ...
   The [33]Raspberry Pi is a low cost Linux microcomputer selling for USD
   ...
   connector, to which expansion boards like [34]this can be attached.
  ...
  Raspberry Pi 2 and 3
   ...
   The [35]Rasbperry Pi 2 Model B has a 900 MHz ARMv7 Cortex-A7 BCM2836
   ...
   The [36]Rasbperry Pi 3 Model B has a 1200 MHz ARMv8 Cortex-A53 BCM2837
   quad-core CPU and has 1 GB of RAM along with on-board Bluetooth and
   WiFi radios.

   The [37]Raspberry Pi 3 Model A+ has the same form factor as the
   ...
   The [38]Raspberry Pi 3 Model B+ has a 1400 MHz ARMv8 Cortex-A53 BCM2837
   ...
   the [39]CM3 and the Raspberry Pi 3 Model A+.
  ...
  Raspberry Pi 4
   ...
   The [40]Raspberry Pi 4 Model B has a 1500 MHz ARMv8 Cortex-A72 BCM2711
   ...
   support enabled, that runs on the [41]CM4 and the Raspberry Pi 4 Model
...
Toolchains
   ...
   [42]Crosstool-NG) for each MuntsOS platform family. Each
   ...
   I also build [43]Free Pascal cross-compilers. These rely on the
   ...
   Cross-toolchain packages built for [44]Debian Linux are available at:
   [45]http://repo.munts.com/debian10
   ...
   the help off a conversion utility like [46]alien).
   ...
   [47]http://repo.munts.com/muntsos/toolchains

Git Repository

   The source code for MuntsOS is available at:

   [48]https://github.com/pmunts/muntsos
...
File Repository
   ...
   [49]http://repo.munts.com/muntsos

[50]Make With Ada Projects

     * 2017 [51]Ada Embedded Linux Framework
     * 2019 [52]Modbus RTU Framework for Ada (Prize Winner!)
   _______________________________________________________________________

   Questions or comments to Philip Munts [53]phil@munts.net
...
References
   ...
   2. http://elinux.org/Device_Tree_Reference
   3. http://repo.munts.com/muntsos/kernels
   4. http://www.debian.org/
   5. http://git.munts.com/muntsos/extensions/GPIO
   6. http://repo.munts.com/muntsos/extensions
   7. https://en.wikipedia.org/wiki/Boot_flag
  ...
  10. http://repo.munts.com/muntsos/thinservers
  11. http://beagleboard.org/bone-original
  12. http://www.ti.com/product/AM3359
  13. http://beagleboard.org/pru
  14. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  15. https://specialcomp.com/beagleboard/bone.htm
  16. http://beagleboard.org/black
  17. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  18. http://www.ti.com/product/AM3358
  19. https://beagleboard.org/black-wireless
  20. https://beagleboard.org/green
  21. https://www.seeedstudio.com/
  22. http://wiki.seeed.cc/Grove_System
  23. https://en.wikipedia.org/wiki/I2C
  24. https://en.wikipedia.org/wiki/Serial_port
  25. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  26. https://beagleboard.org/green-wireless
  27. https://www.mikroe.com/beaglebone
  28. https://www.mikroe.com/beaglebone-mikrobus-cape
  29. https://beagleboard.org/pocket
  30. http://git.munts.com/muntsos/doc/PocketBeaglePinout.pdf
  31. https://www.mikroe.com/mikrobus
  32. https://shop.mikroe.com/click
  33. http://www.raspberrypi.org/
  34. http://git.munts.com/rpi-mcu/expansion/LPC1114
  35. https://www.raspberrypi.org/products/raspberry-pi-2-model-b
  36. https://www.raspberrypi.org/products/raspberry-pi-3-model-b
  37. https://www.raspberrypi.org/products/raspberry-pi-3-model-a-plus
  38. https://www.raspberrypi.org/products/raspberry-pi-3-model-b-plus
  39. https://www.raspberrypi.org/products/compute-module-3
  40. https://www.raspberrypi.org/products/raspberry-pi-4-model-b
  41. https://www.raspberrypi.org/products/compute-module-4
  42. https://crosstool-ng.github.io/
  43. https://www.freepascal.org/
  44. https://www.debian.org/
  45. http://repo.munts.com/debian10
  46. https://admin.fedoraproject.org/pkgdb/package/rpms/alien
  47. http://repo.munts.com/muntsos/toolchains
  48. https://github.com/pmunts/muntsos
  49. http://repo.munts.com/muntsos
  50. https://www.makewithada.org/
  51. https://www.makewithada.org/entry/ada_linux_sensor_framework
  52. https://www.hackster.io/philip-munts/modbus-rtu-framework-for-ada-f33cc6
  53. mailto:phil@munts.net
