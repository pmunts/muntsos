...
Embedded Linux Distribution in a Kernel
   ...
   more [3]device tree files (.dtb) that are specific to particular
   ...
   [4]http://repo.munts.com/muntsos/kernels
...
Extensions
   ...
   packages from the [5]Debian project will probably not work with
   ...
   The [6]GPIO Server extension package demonstrates how to build a Debian
   ...
   [7]http://repo.munts.com/muntsos/extensions
...
Thin Servers
  ...
  Boot Files + Kernel Files + Extensions = Thin Server
   ...
   Note: BeagleBone boards require the [8]boot flag to be set on the FAT32
...
Boards
  ...
  BeagleBone
   ...
   The [12]BeagleBone was one of the first low cost Linux microcomputers.
   It originally sold for USD $89 at its launch in October 2011.

   The BeagleBone has a Texas Instruments [13]Sitara AM3359 processor
   ...
   to the AM3359 console serial port. The BeagleBone also has two [14]PRU
   ...
   are are enabled on the two 46-pin [15]expansion headers:
   ...
   processor are apparently still available from [16]Special Computing.

  BeagleBone Black

   The [17]BeagleBone Black is a cost reduced version of the BeagleBone.
   ...
   pins and peripheral ports available on its two 46-pin [18]expansion
   headers. Even after eMMC, I2C, SPI, and UART pins have been allocated,
   there are 42 GPIO pins available.

   The BeagleBone Black has a Texas Instruments [19]Sitara AM3358
  ...
  BeagleBone Black Wireless
   ...
   The [20]BeagleBone Black Wireless is a variant of the BeagleBone Black
  ...
  BeagleBone Green
   ...
   The [21]BeagleBone Green is a cost reduced version of the BeagleBone
   Black, from Chinese manufacturer [22]Seeed Studio, that sells for about
   USD $44. Changes from the BeagleBone Black design are:
     ...
     * Added two [23]Grove System connectors, one carrying 3.3V [24]I2C
       signals and one carrying 3.3V logic level [25]serial port signals.
   ...
   but provides many more GPIO pins on its two 46-pin [26]expansion
  ...
  BeagleBone Green Wireless
   ...
   The [27]BeagleBone Green Wireless is a variant of the BeagleBone Green
   that has replaced the wired Ethernet interface with a built-in Wifi
   ...
   [28]BeagleBone Click Shield, which has some advantages over the newer
   [29]mikroBus Cape.

  PocketBeagle

   The [30]PocketBeagle is a cost and size reduced version of the
   ...
   following devices on its two 36-pin [31]expansion headers:
   ...
   rows match the [32]MikroElektronika mikroBUS specification. If female
   sockets are installed on the top of the PocketBeagle, two [33]Click
  ...
  Raspberry Pi 1
   ...
   The [34]Raspberry Pi is a low cost Linux microcomputer selling for USD
   ...
   connector, to which expansion boards like [35]this can be attached.
  ...
  Raspberry Pi 2 and 3
   ...
   The [36]Rasbperry Pi 2 Model B has a 900 MHz ARMv7 Cortex-A7 BCM2836
   ...
   The [37]Rasbperry Pi 3 Model B has a 1200 MHz ARMv8 Cortex-A53 BCM2837
   quad-core CPU and has 1 GB of RAM along with on-board Bluetooth and
   WiFi radios.

   The [38]Raspberry Pi 3 Model A+ has the same form factor as the
   ...
   The [39]Raspberry Pi 3 Model B+ has a 1400 MHz ARMv8 Cortex-A53 BCM2837
   ...
   the [40]CM3 and the Raspberry Pi 3 Model A+.
  ...
  Raspberry Pi 4
   ...
   The [41]Raspberry Pi 4 Model B has a 1500 MHz ARMv8 Cortex-A72 BCM2711
   ...
   support enabled, that runs on the [42]CM4 and the Raspberry Pi 4 Model
...
Toolchains
   ...
   [43]Crosstool-NG) for each MuntsOS platform family. Each
   ...
   I also build [44]Free Pascal cross-compilers. These rely on the
   ...
   Cross-toolchain packages built for [45]Debian Linux are available at:
   [46]http://repo.munts.com/debian10
   ...
   the help off a conversion utility like [47]alien).
   ...
   [48]http://repo.munts.com/muntsos/toolchains

Git Repository

   The source code for MuntsOS is available at:

   [49]https://github.com/pmunts/muntsos
...
File Repository
   ...
   [50]http://repo.munts.com/muntsos

[51]Make With Ada Projects

     * 2017 [52]Ada Embedded Linux Framework
     * 2019 [53]Modbus RTU Framework for Ada (Prize Winner!)
   _______________________________________________________________________

   Questions or comments to Philip Munts [54]phil@munts.net
...
References
   ...
   2. http://xmlrpc.com/
   3. http://elinux.org/Device_Tree_Reference
   4. http://repo.munts.com/muntsos/kernels
   5. http://www.debian.org/
   6. http://git.munts.com/muntsos/extensions/GPIO
   7. http://repo.munts.com/muntsos/extensions
   8. https://en.wikipedia.org/wiki/Boot_flag
  ...
  11. http://repo.munts.com/muntsos/thinservers
  12. http://beagleboard.org/bone-original
  13. http://www.ti.com/product/AM3359
  14. http://beagleboard.org/pru
  15. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  16. https://specialcomp.com/beagleboard/bone.htm
  17. http://beagleboard.org/black
  18. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  19. http://www.ti.com/product/AM3358
  20. https://beagleboard.org/black-wireless
  21. https://beagleboard.org/green
  22. https://www.seeedstudio.com/
  23. http://wiki.seeed.cc/Grove_System
  24. https://en.wikipedia.org/wiki/I2C
  25. https://en.wikipedia.org/wiki/Serial_port
  26. http://git.munts.com/muntsos/doc/BeagleBonePinout.pdf
  27. https://beagleboard.org/green-wireless
  28. https://www.mikroe.com/beaglebone
  29. https://www.mikroe.com/beaglebone-mikrobus-cape
  30. https://beagleboard.org/pocket
  31. http://git.munts.com/muntsos/doc/PocketBeaglePinout.pdf
  32. https://www.mikroe.com/mikrobus
  33. https://shop.mikroe.com/click
  34. http://www.raspberrypi.org/
  35. http://git.munts.com/rpi-mcu/expansion/LPC1114
  36. https://www.raspberrypi.org/products/raspberry-pi-2-model-b
  37. https://www.raspberrypi.org/products/raspberry-pi-3-model-b
  38. https://www.raspberrypi.org/products/raspberry-pi-3-model-a-plus
  39. https://www.raspberrypi.org/products/raspberry-pi-3-model-b-plus
  40. https://www.raspberrypi.org/products/compute-module-3
  41. https://www.raspberrypi.org/products/raspberry-pi-4-model-b
  42. https://www.raspberrypi.org/products/compute-module-4
  43. https://crosstool-ng.github.io/
  44. https://www.freepascal.org/
  45. https://www.debian.org/
  46. http://repo.munts.com/debian10
  47. https://admin.fedoraproject.org/pkgdb/package/rpms/alien
  48. http://repo.munts.com/muntsos/toolchains
  49. https://github.com/pmunts/muntsos
  50. http://repo.munts.com/muntsos
  51. https://www.makewithada.org/
  52. https://www.makewithada.org/entry/ada_linux_sensor_framework
  53. https://www.hackster.io/philip-munts/modbus-rtu-framework-for-ada-f33cc6
  54. mailto:phil@munts.net
