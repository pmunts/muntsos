   ...
   This Makefile builds a .zip file containing everything needed to boot a
   base MuntsOS running an SSH server.

   Just download one of the Base SSH Thin Server zip files from
   [4]http://repo.munts.com/muntsos/thinservers and extract it to a
...
References
   ...
   4. http://repo.munts.com/muntsos/thinservers
